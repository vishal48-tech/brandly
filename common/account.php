...
<body class="bg-white">
  <div class="flex flex-col items-center mt-20 px-3">
    ...
    <div class="bg-slate-100 w-full sm:w-full md:w-1/2 lg:w-1/2 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 flex flex-row justify-evenly">
                  ...
                  <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                      ...
                      <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        <button type="button" class="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto" onclick="window.location.href=`delete_account.php`">Delete</button>
                        <button type="button" class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto" onclick="window.location.href=`javascript:history.back()`">Cancel</button>
                      </div>
                    </div>
                  </div>
                </div>
